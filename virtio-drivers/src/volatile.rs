...
pub trait WriteVolatile{
    fn write_volatile_u32(&self, data:u32, io_region:&Box<dyn VirtIoDeviceIo>) -> VirtIoResult<()>;
    fn write_volatile_u64(&self, data:u64, io_region:&Box<dyn VirtIoDeviceIo>) -> VirtIoResult<()>;
}
