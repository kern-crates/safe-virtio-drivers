...
pub struct PciRoot {
    // mmio_base: *mut u32,
    mmio_region: Box<dyn VirtIoDeviceIo>,
    cam: Cam,
}
...
impl PciRoot {
    ...
    pub fn new(mmio_region: Box<dyn VirtIoDeviceIo>, cam: Cam) -> Self {
        let mmio_base = mmio_region.paddr();
    ...
    pub(crate) fn config_read_word(
        ...
        // }
        self.mmio_region.read_volatile_u32_at(address as usize).unwrap()
    }
    ...
    pub(crate) fn config_write_word(
        ...
        // }
        self.mmio_region.write_volatile_u32_at(address as usize, data).unwrap();
    }
...
#[derive(Debug)]
pub struct BusDeviceIterator<'a> {
...
impl Iterator for BusDeviceIterator<'_> {
